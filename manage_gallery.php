...
$query = "SELECT * FROM gallery ORDER BY $sort_by $order LIMIT $limit OFFSET $offset";
...
<main class="manage-gallery-view">
    <?php if($is_admin) include 'admin_sidebar.php'; ?>

    <div class="<?php echo $is_admin ? 'manage-gallery-content' : 'public-content'; ?>">
        <div class="manage-gallery-row">
            <h1 class="manage-gallery-title">Manage Gallery</h1>
            <?php if($is_admin): ?>
                <a href="add_gallery.php" class="add-button">Add Image</a>
            <?php endif; ?>
        </div>
                    ...
                    <tr>
                        ...
                        <?php if($is_admin): ?>
                            <td class="actions-cell">
                                <a href="<?php echo htmlspecialchars($row['image_path']); ?>" target="_blank" class="edit">View</a>
                                <a href="delete_gallery.php?id=<?php echo $row['id']; ?>" class="delete">Delete</a>
                            </td>
                        <?php endif; ?>
                    </tr>
                <?php endwhile; ?>
